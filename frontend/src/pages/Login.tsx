          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-3 bg-[#080810] border border-border rounded focus:border-purple focus:outline-none text-text sys-font-body transition-all pr-10"
                required
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-purple transition-colors"
                tabIndex={-1}
              >
                {showPassword ? (
